        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 offset-md-2">
                    <form action="{{route('admin.visting_judges.store')}}" method="post" enctype="multipart/form-data" id="cat_property">
                        @csrf
                        <input type="hidden" name="go_back" value="0" id="go_back">
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <label for="jud_pic" class="form-label">Judge Picture</label>
                                <input class="form-control dropify" type="file" id="jud_pic" name="jud_pic" data-height="100" data-default-file="">
                            </div>
                            <div class="col-md-2">
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" id="jud_name" name="name" value="{{old('name')}}">
                        </div>
                        <div class="mb-3">
