...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        route('admin.color-management.index'), 'List' =>
        'javascript:void(0);']])
        <!--end breadcrumb-->
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <h6 class="mb-0">List of all Colors</h6>
                    <a href="{{route('admin.color-management.create')}}"
                            ...
                            @foreach($colors as $color)
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        <a href="{{route('admin.color-management.show' ,$color->id)}}" class="text-primary"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                            data-bs-original-title="Views" aria-label="Views"><i
                                                class="bi bi-eye-fill"></i></a>
                                        <a href="{{route('admin.color-management.edit',$color->id)}}" class="text-warning"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                            data-bs-original-title="Edit" aria-label="Edit"><i
                                                class="bi bi-pencil-fill"></i></a>
                                        <a href="{{route('admin.color-management.delete',$color->id)}}" class="text-danger delete-confirm" data-bs-toggle="tooltip"
