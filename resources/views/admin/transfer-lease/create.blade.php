...
<div class="page-content-wrapper">
    <div class="page-content">
        @include('admin.components.breadcrumb',['breadcrumbs'=> ['Add Transfer Lease' =>
        'javascript:void(0)']])
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <select class="form-select mb-3 single-select" aria-label="" id="cat_id">
                        <option selected="">Select Cat</option>
                        @foreach($cats as $cat)
                            <option value="1">{{$cat->pet_name ?? ''}} - {{$cat->registration ?? ''}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="d-grid">
                                ...
                                <button type="submit" link="" class="btn btn-primary">Save and Go Back to List</button>
