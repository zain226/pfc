        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <h6 class="mb-0">List of all Groups</h6>
                ...
                <div class="table-responsive">
                    ...
                    @endif
                    <table id="groups" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                                <th>Breed ID</th>
                                <th>Breed Value</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        <a href="{{route('admin.group.show' ,$group->id)}}" class="text-primary"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                            data-bs-original-title="Views" aria-label="Views"><i
                                                class="bi bi-eye-fill"></i></a>
                                        <a href="{{route('admin.group.edit',$group->id)}}" class="text-warning"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                            data-bs-original-title="Edit" aria-label="Edit"><i
                                                class="bi bi-pencil-fill"></i></a>
                                        <a href="{{route('admin.group.delete',$group->id)}}" class="text-danger delete-confirm" data-bs-toggle="tooltip"
