...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            route('admin.sell_cat.index'), 'List' =>
            'javascript:void(0);']])
            <!--end breadcrumb-->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <div class="d-flex align-items-center">
                        <h6 class="mb-0">Selling Cat Adds</h6>
                        <a href="{{route('admin.sell_cat.create')}}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                            <a href="{{route('admin.sell_cat.show' ,$add->id)}}" class="text-primary"
                                               data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                               data-bs-original-title="Views" aria-label="Views"><i
                                                    class="bi bi-eye-fill"></i></a>
                                            <a href="{{route('admin.sell_cat.edit',$add->id)}}" class="text-warning"
                                               data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                               data-bs-original-title="Edit" aria-label="Edit"><i
                                                    class="bi bi-pencil-fill"></i></a>
                                            <a href="{{route('admin.sell_cat.delete',$add->id)}}"
