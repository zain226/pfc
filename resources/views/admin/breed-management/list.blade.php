...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        route('admin.breed-management.index'), 'List' =>
        'javascript:void(0);']])
        <!--end breadcrumb-->
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <h6 class="mb-0">List of all Breed</h6>
                    <a href="{{route('admin.breed-management.create')}}"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        <a href="{{route('admin.breed-management.show' ,$breed->id)}}" class="text-primary"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                            data-bs-original-title="Views" aria-label="Views"><i
                                                class="bi bi-eye-fill"></i></a>
                                        <a href="{{route('admin.breed-management.edit',$breed->id)}}" class="text-warning"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                            data-bs-original-title="Edit" aria-label="Edit"><i
                                                class="bi bi-pencil-fill"></i></a>
                                        <a href="{{route('admin.breed-management.delete',$breed->id)}}" class="text-danger delete-confirm" data-bs-toggle="tooltip"
