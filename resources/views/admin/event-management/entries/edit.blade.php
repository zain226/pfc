                ...
                <form method="post" action="{{route('admin.entry.update',$id)}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input class="form-control" type="text" id="" value="{{$entry->cacib ?? old('cacib') ?? ''}}" name="cacib">
                        </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                           <label for="grade" class="form-label">Grade</label>
                            <select class="form-select mb-3" aria-label="" name="grade">
                                                    <option value="">Select One</option>
                                                    @foreach($titles as $title)
                                                        <option value="{{$title->id}}" {{($entry->grade == $title->id) ? 'selected' : ''}}>{{$title->title ?? ''}}</option>
                                                    @endforeach
                                                </select>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="position" class="form-label">Rank</label>
