...
<div class="page-content">
    @include('frontend.components._inner_header',['bg_img'=>asset('frontend/images/background/Visiting-judges.png'),'breedcrumb'=>'Visiting Judges','page_title'=>'Visiting Judges' , 'overlay' => 'none'])
    <div class="clearfix">
        <!-- Team member -->
        <div class="section-full bg-white content-inner">
                <div class="section-head text-center ">
                    <h3 class="h3">Meet Our Honorable Visiting Judges</h3>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 m-b30">
                            <div class="dez-box">
                                ...
                                <div class="dez-info p-a20 p-t40">
                                    ...
                                    <p style="text-align: center; "><a href="{{route('visiting.judge.detail',$judge->slug)}}" style="color: #00783a !important;">Read Bio</a></p>
                                </div>
                            </div>
                        </div>
                        @endforeach
