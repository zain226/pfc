...
@section('content')
    <div class="page-content">
           @include('frontend.components._inner_header',['bg_img'=>asset('frontend/images/background/membership.png'),'breedcrumb'=>'Membership Application','page_title'=>'Membership Application' , 'overlay' => 'none'])
        <div class="section-full content-inner contact-style-1">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="m-b0">
                        <h2 class="text-uppercase">Online Membership Application</h2>
                        ...
                        <form method="post" action="{{route('membership-application.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input name="phone" type="tel" id="contact" class="form-control"
