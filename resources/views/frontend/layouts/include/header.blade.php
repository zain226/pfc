    ...
    <header class="header-area style-1">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div class="header-logo">
                <a href="{{route('home')}}"><img alt="image" class="img-fluid" src="{{asset('frontend/assets/images/pfc-img/PFC-logo.png')}}" width="80px" height="80px"></a>
            </div>
            <div class="main-menu">
                <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                    <div class="mobile-logo-wrap">
                        <a href="{{route('home')}}"><img alt="image" src="{{asset('frontend/assets/images/pfc-img/PFC-logo.png')}}"></a>
                    </div>
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item-has-children">
                        <a href="javascript:void(0);">Services</a><i class="bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                            <li><a href="{{route('service-details')}}">Daycare </a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children">
                    ...
                    <li><a href="{{route('faqs')}}">Faq</a></i></li>
                    <li class="menu-item-has-children">
