...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            route('user.single_cat_reg.index'), 'List' =>
            'javascript:void(0);']])
            <!--end breadcrumb-->
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h6 class="mb-0">Single Cat Registration</h6>
                                            <a href="{{route('user.single_cat_reg.create')}}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                            <a href="{{route('user.single_cat_reg.show' ,$application->id)}}"
                                               class="text-primary"
                                               data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                               data-bs-original-title="Views" aria-label="Views"><i
                                                    class="bi bi-eye-fill"></i></a>
{{--                                            <a href="{{route('user.single_cat_reg.edit',$application->id)}}" class="text-warning"--}}
{{--                                               data-bs-toggle="tooltip" data-bs-placement="bottom" title=""--}}
