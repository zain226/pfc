...
<div class="page-content-wrapper">
    <div class="page-content">
        @include('user.components.breadcrumb',['breadcrumbs'=> ['Litter Registration Detail' =>
        route('user.litter_registration.index'), 'Show' => '']])
            ...
            <div class="card-body">
                <table class="table mb-0">
                    <tr>
                        ...
                        <td><a href="{{route('user.stud_certificate.show',$stud->id)}}" target="_blank">{{$stud->id ?? ''}}</a></td>
                    </tr>
                    <tr>
