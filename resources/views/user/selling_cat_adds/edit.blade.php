...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            route('user.sell_cat.index'), 'Update Advertisement' =>
            'javascript:void(0);']])
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('user.sell_cat.update',$id)}}" method="post">
                        @csrf
...
{{--                                <option selected="" value="{{$selling_ad->cat_property_id ?? ''}}"> Enter at Least 2 character</option>--}}
                        ...
                        <input type="hidden" name="status" value="{{$selling_ad->status}}">
                        <div class="mb-3">
                       ...
                       <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="number" placeholder="923**********" id="contact" name="contact" value="{{$selling_ad->contact ?? old('contact')}}">
                        </div>
                        <div class="mb-3">
