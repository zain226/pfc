            ...
            <form method="post" action="{{route('admin.breeder-management.store')}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="input" id="breeder_name" name="name">
                    </div>
                    <div class="mb-3">
                        <label for="contact" class="form-label">Contact </label>
                        <input class="form-control" type="input" id="contact" name="contact">
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">Address</label>
                        <input class="form-control" type="input" id="address" name="address">
                    </div>
                    <div class="mb-3">
                        <label for="city" class="form-label">City</label>
                        <input class="form-control" type="input" id="petName" name="city">
                    </div>
                    <div class="mb-3">
                        <label for="kennel" class="form-label">Kennel</label>
                        <input class="form-control" type="input" id="petName" name="kennel">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="input" id="registration-breeder" name="registration_no">
                    </div>
                    <div class="mb-3"></div>
                    <div class="mb-3">
