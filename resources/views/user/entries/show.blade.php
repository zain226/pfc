...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            route('user.event.entry.index',$entry->event_id), 'Show Entry Detail' => 'javascript:void(0);']])
            <h6 class="mb-0 text-uppercase">{{ $entry->event->title.' '.$entry->event->city. ' '.date('d-M-Y',strtotime($entry->event->event_date)) ?? '' }}</h6>
            <hr>
            <div class="card">
                <div class="card-body">
